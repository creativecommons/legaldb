...
class BaseModel(models.Model):
    notes = models.TextField(
        blank=True, null=True, help_text=_("Internal notes or description.")
    )
    created_at = models.DateTimeField(
        auto_now_add=True,
        help_text=_("A timestamp of when the object is first created."),
    )
...
class LegalResource(BaseModel):
    ...
    license = models.CharField(
        ...
        null=True,
        help_text=_(
            "The Creative Commons license associated with the legal resource."
        ),
    )
    ...
    status = models.PositiveSmallIntegerField(
        ...
        help_text=_("The stage of the review process where the resource is."),
    )
...
class Case(LegalResource):
    ...
    country = CountryField(
        blank_label=_("Select a country"), blank=True, null=True
    )
    ...
    is_pending = models.BooleanField(
        blank=True,
        null=True,
        help_text=_("Indicate if it is an ongoing case or not."),
    )
